        ...
        <div class="crt-list">
          <?php if (!empty($webnovels)): ?>
            ...
            <div class="crt-row" id="webnovel-<?php echo esc_attr($wn->post_name); ?>">
              ...
              <a class="crt-title" href="<?php echo esc_url(get_permalink($wn)); ?>" data-open-webnovel="<?php echo esc_attr($wn->post_name); ?>" aria-describedby="<?php echo esc_attr($tip_id); ?>">
                <span class="crt-title-name"><?php echo esc_html(get_the_title($wn)); ?></span>
                <span class="crt-title-slug"><?php echo esc_html($slug); ?></span>
                <span class="crt-tip" id="<?php echo esc_attr($tip_id); ?>" role="tooltip">
                  <span class="crt-tip-title"><?php echo esc_html(get_the_title($wn)); ?></span>
                  <?php if ($genre): ?><span class="crt-tip-genre"><?php echo esc_html($genre); ?></span><?php endif; ?>
                </span>
              </a>
          ...
          <div class="mechape-body-wrap">
            <div class="mechape-body">
              ...
              <ul class="mechape-features">
                ...
                <li><strong>Its own engine</strong> &mdash; llama.cpp ships inside; GPU auto-detection, one-click model switching, honest health indicator</li>
