...
add_action('init', function () {
    $blocks = [
        ...
        ['slug' => 'flagship-serial-page', 'title' => 'Flagship Serial Landing Page', 'render' => 'ht_render_flagship_serial_page', 'icon' => 'cover-image'],
        ...
        ['slug' => 'book-content',          'title' => 'Book Content (post_content)', 'render' => 'ht_render_book_content',         'icon' => 'text-page'],
